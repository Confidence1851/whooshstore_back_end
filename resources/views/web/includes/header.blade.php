        ...
        <div class="header__top">
            <div class="ps-container">
                <div class="header__left">
                    ...
                    </div><a class="ps-logo" href="index.html"><img src="{{ $web_source }}/img/logo_light.png" alt=""></a>
                </div>
                        ...
                        <div class="ps-panel--search-result">
                            <div class="ps-panel__content">
                                <div class="ps-product ps-product--wide ps-product--search-result">
                                    <div class="ps-product__thumbnail"><a href="product-default.html"><img src="{{ $web_source }}/img/products/arrivals/1.jpg" alt=""></a></div>
                                ...
                                <div class="ps-product ps-product--wide ps-product--search-result">
                                    <div class="ps-product__thumbnail"><a href="product-default.html"><img src="{{ $web_source }}/img/products/arrivals/2.jpg" alt=""></a></div>
                                ...
                                <div class="ps-product ps-product--wide ps-product--search-result">
                                    <div class="ps-product__thumbnail"><a href="product-default.html"><img src="{{ $web_source }}/img/products/arrivals/3.jpg" alt=""></a></div>
                                ...
                                <div class="ps-product ps-product--wide ps-product--search-result">
                                    <div class="ps-product__thumbnail"><a href="product-default.html"><img src="{{ $web_source }}/img/products/arrivals/4.jpg" alt=""></a></div>
                                ...
                                <div class="ps-product ps-product--wide ps-product--search-result">
                                    <div class="ps-product__thumbnail"><a href="product-default.html"><img src="{{ $web_source }}/img/products/arrivals/5.jpg" alt=""></a></div>
                                ...
                                <div class="ps-product ps-product--wide ps-product--search-result">
                                    <div class="ps-product__thumbnail"><a href="product-default.html"><img src="{{ $web_source }}/img/products/arrivals/6.jpg" alt=""></a></div>
                            ...
                            <div class="ps-cart__content">
                                <div class="ps-cart__items">
                                    <div class="ps-product--cart-mobile">
                                        <div class="ps-product__thumbnail"><a href="#"><img src="{{ $web_source }}/img/products/clothing/7.jpg" alt=""></a></div>
                                        <div class="ps-product__content"><a class="ps-product__remove" href="#"><i class="icon-cross"></i></a><a href="product-default.html">MVMTH Classical Leather Watch In Black</a>
                                            <p><strong>Sold by:</strong> YOUNG SHOP</p><small>1 x $59.99</small>
                                        </div>
                                    </div>
                                    <div class="ps-product--cart-mobile">
                                        <div class="ps-product__thumbnail"><a href="#"><img src="{{ $web_source }}/img/products/clothing/5.jpg" alt=""></a></div>
