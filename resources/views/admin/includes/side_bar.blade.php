    ...
    <div class="ps-sidebar">
        <div class="ps-sidebar__top">
            <div class="ps-block--user-wellcome">
                <div class="ps-block__left"><img src="{{$admin_source}}/img/user/admin.jpg" alt="" /></div>
                <div class="ps-block__right">
                    <p>Hello,<a href="#">KioskXtra Store</a></p>
                </div>
        ...
        <div class="ps-sidebar__content">
            <div class="ps-sidebar__center">
                <ul class="menu">
                    <li><a class="active" href="index-2.html"><i class="icon-home"></i>Dashboard</a></li>
                    <li><a href="{{route('adminProducts')}}"><i class="icon-database"></i>Products</a></li>
            ...
            <div class="ps-sidebar__footer">
                <div class="ps-copyright"><img src="{{$admin_source}}/img/logo.png" alt="">
