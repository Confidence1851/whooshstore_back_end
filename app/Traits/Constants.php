...
trait Constants
{
    ...
    /**Returns image path for crypto currencies */
    public $cryptoCurrencyImagePath = 'images/crypto';


    /**Returns image path for fiat currencies */
    public $fiatCurrencyImagePath = 'images/fiat';
